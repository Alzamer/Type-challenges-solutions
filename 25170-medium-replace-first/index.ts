...
type ReplaceFirst<T extends readonly unknown[], S, R, C extends unknown[] = [], First extends boolean = true> = T extends [infer L, ...infer Rest] ? 
  L extends S ? First extends true ? ReplaceFirst<Rest, S, R, [...C, R], false> : ReplaceFirst<Rest, S, R, [...C, L], First> : ReplaceFirst<Rest, S, R, [...C, L]> : C;
